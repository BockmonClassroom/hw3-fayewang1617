...
data = pd.read_csv("/Users/faye/Documents/hw-5110/hw3-fayewang1617/merged_data_with_gender.csv")
...
data_cleaned.to_csv("/Users/faye/Documents/hw-5110/hw3-fayewang1617/cleaned_data3.csv", index=False)
